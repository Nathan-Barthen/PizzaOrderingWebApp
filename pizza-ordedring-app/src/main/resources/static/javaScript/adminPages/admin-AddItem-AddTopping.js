 ...
 *  Used for the toppings. This will add the html for a topping if the [ + ] box is clicked.
 *  
 *  
*/
	...
	addMainTopping.addEventListener("click", function() {
	  ...
	  newToppingRow.innerHTML = `
			...
			<div id="add-topping-type" class="addItemToppingCol">	
				...
				<input type="hidden" value="default" name="toppingType" id="toppingTypeInput">
			...
			<div id="add-topping-isPizza" class="addItemToppingCol">	
				...
				<input type="hidden" value="Select" name="isPizza" id="isPizzaInput">
				<div id="checkisPizza">
				    <span id="emptyText"></span>
